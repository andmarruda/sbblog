...
{
    use HasFactory;
    protected $fillable = ['brand_image', 'slogan', 'section', 'active', 'google_analytics', 'google_ads_script', 'google_optimize_script', 'title', 'description', 'autoconvert_webp', 'comment_config_id'];
